package hq.com.aop.exception;

import java.security.PrivilegedActionException;

/**
 * @title : zookeeper 分布式锁异常
 * @describle :
 * <p>
 * Create By yinhaiquan
 * @date 2017/7/10 18:44 星期一
 */
public class ZookeeperLockException extends Exception {
     ...
     * @since 1.7
     */
    public ZookeeperLockException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
